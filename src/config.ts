...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "一个演示网站",
	siteURL: "https://www.nfq.dpdns.org/", // Vercel 域名
	...
	banner: {
		...
		src: {
			desktop: "https://www.dmoe.cc/random.php", // 桌面横幅使用随机动漫背景 API
			mobile: "https://www.dmoe.cc/random.php", // 移动端横幅使用随机动漫背景 API
		}, // 使用外部随机动漫背景 API
		...
		homeText: {
			...
			title: "今天是平凡的一天，但也是美好的一天", // 主页横幅主标题
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	src: {
		desktop: "https://www.dmoe.cc/random.php", // 桌面全屏壁纸使用随机动漫背景 API
		mobile: "https://www.dmoe.cc/random.php", // 移动端全屏壁纸使用随机动漫背景 API
	}, // 使用外部随机动漫背景 API
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/395592943",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	position: "right", // 模型位置：left 或 right
	width: 280, // 默认宽度
	height: 250, // 默认高度
